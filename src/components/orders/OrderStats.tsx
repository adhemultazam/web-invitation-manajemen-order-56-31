    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
      ...
      <div className="rounded-lg p-2 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border border-blue-200 dark:border-blue-800 shadow-sm">
        <div className="flex justify-between mb-1">
          ...
          <div className="rounded-full w-5 h-5 flex items-center justify-center bg-blue-500 dark:bg-blue-400">
            <ShoppingCart className="w-3 h-3 text-white" />
          </div>
        </div>
        <p className="text-xl md:text-2xl font-bold text-blue-800 dark:text-blue-200">{totalOrders}</p>
      </div>
      ...
      <div className="rounded-lg p-2 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border border-purple-200 dark:border-purple-800 shadow-sm">
        <div className="flex justify-between mb-1">
          ...
          <div className="rounded-full w-5 h-5 flex items-center justify-center bg-purple-500 dark:bg-purple-400">
            <DollarSign className="w-3 h-3 text-white" />
          </div>
        </div>
        <p className="text-xl md:text-2xl font-bold text-purple-800 dark:text-purple-200">{formatCurrency(totalRevenue)}</p>
      </div>
      ...
      <div className="rounded-lg p-2 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border border-green-200 dark:border-green-800 shadow-sm">
        <div className="flex justify-between mb-1">
          ...
          <div className="rounded-full w-5 h-5 flex items-center justify-center bg-green-500 dark:bg-green-400">
            <Check className="w-3 h-3 text-white" />
          </div>
        </div>
        <p className="text-sm md:text-xl font-bold text-green-800 dark:text-green-200">
          {paidOrders.length} <span className="text-xs md:text-sm font-medium">({formatCurrency(paidAmount)})</span>
        </p>
      </div>
      ...
      <div className="rounded-lg p-2 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 border border-red-200 dark:border-red-800 shadow-sm">
        <div className="flex justify-between mb-1">
          ...
          <div className="rounded-full w-5 h-5 flex items-center justify-center bg-red-500 dark:bg-red-400">
            <X className="w-3 h-3 text-white" />
          </div>
        </div>
        <p className="text-sm md:text-xl font-bold text-red-800 dark:text-red-200">
          {unpaidOrders.length} <span className="text-xs md:text-sm font-medium">({formatCurrency(unpaidAmount)})</span>
        </p>
      </div>
    </div>
  );
