      ...
      <CardContent className="p-0">
        <Tabs value={activeResourceTab} onValueChange={setActiveResourceTab} className="w-full">
          <div className="border-b bg-muted/20">
            <TabsList className="w-full h-10 bg-transparent justify-start px-3 gap-1 overflow-x-auto">
              <TabsTrigger 
                value="packages" 
                className="px-2 py-1 text-sm data-[state=active]:shadow-none data-[state=active]:bg-background data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none"
              >
                Paket
              </TabsTrigger>
              <TabsTrigger 
