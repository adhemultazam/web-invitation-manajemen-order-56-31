...
export default function Transactions() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Moved expense reminder alert here, below the statistics cards and made text smaller */}
      {unpaidFixedExpenses.length > 0 && selectedMonth !== "Semua Data" && selectedYear !== "Semua Data" && (
        <Alert variant="default" className="bg-amber-50 border-amber-200 py-2">
          ...
          <AlertDescription className="text-xs">
            <p className="mb-1">Anda memiliki {unpaidFixedExpenses.length} pengeluaran tetap yang belum dibayar bulan ini:</p>
